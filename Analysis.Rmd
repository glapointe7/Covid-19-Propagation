...
$$
\begin{aligned}
  R(t) &= \gamma N \int \frac{du}{N \beta (u - 1)} \\
       &= \frac{\gamma}{\beta} \int \frac{du}{u - 1} \\
       &= \frac{\gamma}{\beta} \ln |u - 1| + R_0
\end{aligned}
$$
